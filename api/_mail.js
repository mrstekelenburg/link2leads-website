...
function prepBlock(dateStr, variant) {
  ...
  const kop = isFull
    ? 'Rond de onboarding vast af'
    : 'Laat vooraf even je gegevens achter';

  const tekst = isFull
    ? `Je antwoorden hierboven geven me al richting. De volledige onboarding staat op ${KLANT_URL} en vult het beeld aan met je aanbod, doelgroep en bewijs. Zo kan ik ${wanneer} direct met een strategie komen in plaats van eerst alles uit te vragen. Niet verplicht, wel makkelijk.`
  ...
  <tr><td align="center" style="padding:36px 12px 28px;">
    ...
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;">
      <tr><td align="center" style="padding:18px 24px 0;font-family:${FONT};font-size:11px;line-height:1.6;color:#5A616E;">
        ...
        Deze mail hoort bij een afspraak die je zelf hebt ingepland.
      </td></tr>
    </table>
